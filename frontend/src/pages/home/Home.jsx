    ...
    <>
      ...
      >
        <div className="xl:w-[1200px] xl:mx-auto px-4 pt-4">
          <div className="py-10">
            <button
              className="flex items-center bg-yellow-50 border border-yellow-400 w-fit px-4 py-1 rounded-lg sm:mx-auto group shadow-md hover:-translate-y-2 cursor-pointer duration-500"
            ...
            <p className="text-md text-justify sm:text-center md:text-xl lg:w-4/6 lg:mx-auto font-normal text-gray-500">
              Harness the power of data to build the ultimate team with our
              advanced linear programming model
            </p>
